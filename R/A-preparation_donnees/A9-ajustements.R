...
bv_2022_final_9 <- bv_2022_final_8 %>%
  mutate(
    CLUSTER_AFM_IDF_DENSITE_FILOSOFI_5 = ifelse(
    ...
    CLUSTER_AFM_IDF_DENSITE_FILOSOFI_2017_3 = ifelse(
      REG == "11" & !is.na(CLUSTER_AFM_DENSITE_FILOSOFI_2017_3),
      paste0("idf_", CLUSTER_AFM_DENSITE_FILOSOFI_2017_3),
      paste0("hdf_", CLUSTER_AFM_DENSITE_FILOSOFI_2017_3)
    ),
    ...
    CLUSTER_AFM_IDF_DENSITE_2017_3 = ifelse(
      REG == "11" & !is.na(CLUSTER_AFM_DENSITE_2017_3),
      paste0("idf_", CLUSTER_AFM_DENSITE_2017_3),
      paste0("hdf_", CLUSTER_AFM_DENSITE_2017_3)
    ),
    CLUSTER_AFM_IDF_DENSITE_2017_8 = ifelse(
      REG == "11" & !is.na(CLUSTER_AFM_DENSITE_2017_8),
      paste0("idf_", CLUSTER_AFM_DENSITE_2017_8),
      paste0("hdf_", CLUSTER_AFM_DENSITE_2017_8)
    )
  ) %>% 
  mutate(
    CLUSTER_AFM_REG_DENSITE_FILOSOFI_5 = paste(REG, CLUSTER_AFM_DENSITE_FILOSOFI_5, sep = "_"),
    CLUSTER_AFM_REG_DENSITE_FILOSOFI_2017_3 = paste(REG, CLUSTER_AFM_DENSITE_FILOSOFI_2017_3, sep = "_"),
    ...
    CLUSTER_AFM_REG_DENSITE_2017_8 = paste(REG, CLUSTER_AFM_DENSITE_2017_8, sep = "_")
  )
